...
| Captured recurring payment: 100000 base units → 0.1 USDC | `transferRecurring-devnet`, offline `devnet:verify`, Rust presentation and Swift SDK tests; iOS checks the capture with and without mint data and engine diagnostics for unresolved amounts. |
